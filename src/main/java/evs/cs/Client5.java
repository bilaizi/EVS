...
public class Client5 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        hostInfoTables.removeIf(s -> s.getPort() == 6005);
        ...
        socket = new Socket("192.168.0.135", 6005, InetAddress.getByName("192.168.0.135"), 5005);
