...
public class Client7 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        hostInfoTables.removeIf(s -> s.getPort() == 6007);
        ...
        socket = new Socket("192.168.0.137", 6007, InetAddress.getByName("192.168.0.137"), 5007);
