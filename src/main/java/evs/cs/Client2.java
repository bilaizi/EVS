...
public class Client2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        hostInfoTables.removeIf(s -> s.getPort() == 6002);
        ...
        socket = new Socket("192.168.0.132", 6002, InetAddress.getByName("192.168.0.132"), 5002);
