...
public class Server3 {
    ...
    private void init() {
        try {
            ServerSocket serverSocket = new ServerSocket(6003, 100, InetAddress.getByName("192.168.0.133"));
            while (true) {
    ...
    private class HandlerThread implements Runnable {
        ...
        public void run() {
            try {
                if (((InetSocketAddress) socket.getRemoteSocketAddress()).getPort() == 5003) {
                    ...
                    if (flag) {
                        ...
                        sender3.setHost("192.168.0.133");
                        ds1.setSender(sender3);
                        ...
                        if (Math.random() > 0.5) {
                            ...
                            hostInfoTables.removeIf(s -> Objects.equals(s.getHost(), sender3.getHost()));
