...
public class Client4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        hostInfoTables.removeIf(s -> s.getPort() == 6004);
        ...
        socket = new Socket("192.168.0.134", 6004, InetAddress.getByName("192.168.0.134"), 5004);
