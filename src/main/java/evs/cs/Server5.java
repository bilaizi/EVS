...
public class Server5 {
    ...
    private void init() {
        try {
            ServerSocket serverSocket = new ServerSocket(6005, 100, InetAddress.getByName("192.168.0.135"));
            while (true) {
    ...
    private class HandlerThread implements Runnable {
        ...
        public void run() {
            try {
                if (((InetSocketAddress) socket.getRemoteSocketAddress()).getPort() == 5005) {
                    ...
                    if (flag) {
                        ...
                        sender5.setHost("192.168.0.135");
                        ds1.setSender(sender5);
