...
public class Client6 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        hostInfoTables.removeIf(s -> s.getPort() == 6006);
        ...
        socket = new Socket("192.168.0.136", 6006, InetAddress.getByName("192.168.0.136"), 5006);
