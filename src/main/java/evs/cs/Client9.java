...
public class Client9 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        hostInfoTables.removeIf(s -> s.getPort() == 6009);
        ...
        socket = new Socket("192.168.0.139", 6009, InetAddress.getByName("192.168.0.139"), 5009);
