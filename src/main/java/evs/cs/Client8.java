...
public class Client8 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        hostInfoTables.removeIf(s -> s.getPort() == 6008);
        ...
        socket = new Socket("192.168.0.138", 6008, InetAddress.getByName("192.168.0.138"), 5008);
